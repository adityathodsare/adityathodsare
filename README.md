...
I build scalable full-stack and AI-powered systems — from real-time IoT platforms to LLM-driven dashboards.

---

### 🛠️ Tech Stack

**Backend:** Spring Boot · FastAPI · REST APIs · Microservices · RabbitMQ
**Frontend:** Next.js · React · TypeScript · JavaScript
**Languages:** Java · Python · TypeScript · SQL
**Databases:** MySQL · MongoDB
**AI/LLM:** Gemini API · LLM Integration · Claude Code · Cursor
**DevOps:** Docker · Jenkins · Git · Grafana
**IoT:** ESP32 · YOLOv8 · ThingSpeak
